/* 
 * @(#)src/contract/jvm/sov/jvmdi.h, xs130, xs130, 20000602 1.6.1.1
 * ===========================================================================
 ...
 * ------  ----   ------  ----------------------------------------------------
 * 006609  030900 hdjbm   Inserted void for function prototypes to please icc
 *
 * ===========================================================================
 */
...
#define JVMDI_ClearAllBreakpoints(a_env) ( \
              SetJVMDIfromJNIEnv(a_env), \
              jvmdi_interface->ClearAllBreakpoints(void) )    /*ibm@6609*/
