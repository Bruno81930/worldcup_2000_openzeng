/*
 * @(#)src/contract/jvm/sov/jvmpi.h, xs130, xs130, 20000602 1.12.1.2
 * ===========================================================================
 ...
 * ------  ----   ------  ----------------------------------------------------
 * 004142  081199 hdcrk:  Add profiler enabled event identifier
 * 005637  011100 hdece:  Add JVMPI_EVENT_INSTRUCTION_START
 * 004458  012500 hdjbm   Part II of JVMPI -> JIT implementation
 * 008444  031400 hdece:  Ensure OK for C++
 * 009193  042700 mikew   Update version#, 'jobject/ID' interface fn.s,
 *                        sync 'instruction' struct with Sun's 'jvmpi.h'
 *
 * ===========================================================================
 */
...
#define JVMPI_VERSION_1_1	((jint)0x10000002)	/* current version */ /*ibm@9193*/
...
typedef struct {
    ...
    union {
        ...
        struct {
            ...
            void * (*malloc_f)(size_t);       /* memory allocation function *//*ibm.120*/
        } class_load_hook;
        ...
        } instruction;                  /*ibm@5637*/

        struct {
            jmethodID method_id;      /* id of method */
            jobjectID obj_id;         /* id of target object */
            jint flags;               /* control flags */
            jint reserv1;
            jint reserv2;
            jint reserv3;
            jint reserv4;
...
typedef struct {
    ...
    jobject   (*jobjectID2jobject)(jobjectID jid);	/*ibm@9193*/
    jobjectID (*jobject2jobjectID)(jobject jobj);	/*ibm@9193*/
...
#define JVMPI_EVENT_INSTRUCTION_START       ((jint)9)       /*ibm@5637*/       
...
/*
 * IBM definitions for JIT profiling
 */

#define JVMPI_EVENT_PROFILER_ENABLED              ((jint)31)        /*ibm@4142*/

#define JVMPI_EVENT_DISABLE_COMPATIBILITY         ((jint )2000)         /*ibm@1424*/
#define JVMPI_EVENT_GEN_COMPILED_METHOD           ((jint )2001)         /*ibm@1424*/
#define JVMPI_EVENT_GEN_INLINE_METHOD             ((jint )2002)         /*ibm@1424*/
#define JVMPI_EVENT_GEN_BUILTIN_METHOD            ((jint )2003)         /*ibm@1424*/
#define JVMPI_EVENT_COMPILED_METHOD_ENTRY         ((jint )2004)         /*ibm@1424*/
#define JVMPI_EVENT_COMPILED_METHOD_ENTRY2        ((jint )2005)         /*ibm@1424*/
#define JVMPI_EVENT_COMPILED_METHOD_EXIT          ((jint )2006)         /*ibm@1424*/
#define JVMPI_EVENT_INLINE_METHOD_ENTRY           ((jint )2007)         /*ibm@1424*/
#define JVMPI_EVENT_INLINE_METHOD_ENTRY2          ((jint )2008)         /*ibm@1424*/
#define JVMPI_EVENT_BUILTIN_METHOD_ENTRY          ((jint )2009)         /*ibm@1424*/
#define JVMPI_EVENT_BUILTIN_METHOD_ENTRY2         ((jint )2010)         /*ibm@1424*/
#define JVMPI_EVENT_NATIVE_METHOD_ENTRY           ((jint )2011)         /*ibm@1424*/
#define JVMPI_EVENT_NATIVE_METHOD_ENTRY2          ((jint )2012)         /*ibm@1424*/
#define JVMPI_EVENT_COMPILING_START               ((jint )2013)         /*ibm@1424*/
#define JVMPI_EVENT_COMPILING_END                 ((jint )2014)         /*ibm@1424*/
#define JVMPI_EVENT_COMPILER_GC_START             ((jint )2015)         /*ibm@1424*/
#define JVMPI_EVENT_COMPILER_GC_END               ((jint )2016)         /*ibm@1424*/
#define JVMPI_EVENT_DUMMY1                        ((jint )2017)         /*ibm@4458*/
#define JVMPI_EVENT_DUMMY2                        ((jint )2018)         /*ibm@4458*/
#define JVMPI_EVENT_DUMMY3                        ((jint )2019)         /*ibm@4458*/
#define JVMPI_EVENT_DUMMY4                        ((jint )2020)         /*ibm@4458*/
#define JVMPI_EVENT_DUMMY5                        ((jint )2021)         /*ibm@4458*/
#define JVMPI_EVENT_DUMMY6                        ((jint )2022)         /*ibm@4458*/
#define JVMPI_EVENT_DUMMY7                        ((jint )2023)         /*ibm@4458*/
#define JVMPI_EVENT_DUMMY8                        ((jint )2024)         /*ibm@4458*/

#define JVMPI_IBM_EVENT_START                     JVMPI_EVENT_DISABLE_COMPATIBILITY                     /*ibm@1424*/
#define JVMPI_IBM_EVENT_END                       JVMPI_EVENT_DUMMY8                           		/*ibm@4458*/
#define JVMPI_IBM_EVENTS                          JVMPI_IBM_EVENT_END-JVMPI_IBM_EVENT_START+1           /*ibm@1424*/

#define JVMPI_GENERIC_FLAG_DISABLE_GC   ((jint)1)       /*ibm@4458*/
#define JVMPI_GENERIC_FLAG_CHECK_EVENT  ((jint)2)       /*ibm@4458*/
